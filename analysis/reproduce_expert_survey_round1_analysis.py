...
def main():
    ...
    parser.add_argument("--zip", required=True, type=Path, help="ZIP archive containing completed expert survey XLSX files.")
    parser.add_argument("--output-report", default=Path("expert_survey_round1_analysis_report_round1.xlsx"), type=Path, help="Output XLSX report path.")
    parser.add_argument("--output-dir", default=Path("expert_analysis_outputs_round1"), type=Path, help="Directory for CSV outputs.")
    parser.add_argument("--output-zip", default=Path("expert_survey_round1_analysis_outputs_round1.zip"), type=Path, help="ZIP archive containing report and CSV outputs.")
    parser.add_argument("--extract-dir", default=Path("_expert_surveys_extract"), type=Path, help="Temporary extraction directory.")

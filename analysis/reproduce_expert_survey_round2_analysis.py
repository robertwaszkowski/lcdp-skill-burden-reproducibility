...
def main():
    ...
    parser.add_argument("--round1-zip", required=True, help="ZIP with 15 completed Round 1 Excel files")
    parser.add_argument("--round2-zip", required=True, help="ZIP with 15 completed Round 2 Excel files")
    parser.add_argument("--output-report", required=True, help="Output Excel analysis report path")
    parser.add_argument("--output-dir", required=True, help="Output directory for CSV files")
    parser.add_argument("--output-zip", required=True, help="Output ZIP archive for CSV files")
